...
export const commandData = new SlashCommandBuilder()
  ...
  .setDescription(str.partyCreateCommandDescription)
  .addStringOption(option => option.setName('name').setDescription(str.partyNameCommandOptionDescription).setRequired(true))
  .addStringOption(option => option.setName('description').setDescription(str.partyDescriptionCommandOptionDescription))
  .addStringOption(option => option.setName('date').setDescription(str.partyDateCommandOptionDescription))
  .addStringOption(option => option.setName('level').setDescription(str.partyLevelCommandOptionDescription))
  .addNumberOption(option => option.setName('slots').setDescription(str.partySlotsCommandOptionDescription))
