...
export const commandData = new SlashCommandBuilder()
  ...
  .setDescription(str.partyUpdateCommandDescription)
  .addNumberOption(option => option.setName('id').setDescription(str.partyIdCommandOptionDescription).setRequired(true))
  .addStringOption(option => option.setName('name').setDescription(str.partyNameCommandOptionDescription))
