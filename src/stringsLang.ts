export default {
  ...
  recipeRarityCommandOptionDescription: 'The rarity of the recipe',
  recipeNameCommandOptionDescription: 'Name or part of a recipe name',
  recipeCommandDescription: 'Search by recipe name and / or rarity',
  ...
  equipCommandDescription: 'Search by equipment name and / or rarity',
